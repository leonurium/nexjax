...
function readConfig(projectRoot) {
  ...
  // Backwards compatibility: map legacy usesNonExemptEncryption flag
  if (typeof existingConfig.usesNonExemptEncryption === "boolean") {
    infoPlistBooleans.ITSAppUsesNonExemptEncryption =
      existingConfig.usesNonExemptEncryption;
  }
